...
<script>
    ...
    const consumer = {
        getListDotXetTotNghiep: function () {
            const url = '/api/dot-xet-tot-nghiep' + window.location.search;
            return axios.get(url).then(response => response.data);
        },
        getListDotXet: function (chuongtrinh) {
            const url = "/api/dot-thi/all/dot-xet-tn?chuongtrinh=" + chuongtrinh;
            return axios.get(url).then((response) => response.data);
        },
        getDotXetTotNghiep: function (dxtn_id) {
            const url = '/api/dot-xet-tot-nghiep/' + dxtn_id;
            return axios.get(url).then(response => response.data);
        },
        saveOrUpdate: function (formData) {
            if (formData.dxtn_id == null) {
                return axios.post('/api/dot-xet-tot-nghiep', formData);
            } else {
                return axios.put('/api/dot-xet-tot-nghiep/' + formData.dxtn_id, formData);
            }
        },
        destroy: function (dxtn_id) {
            return axios.delete('/api/dot-xet-tot-nghiep/' + dxtn_id);
        },
        ...
        getListQuyetDinh: function (loai) {
            const url = '/api/quyet-dinh/all/'+ 1;
            return axios.get(url).then(response => response.data);
        },
        saveOrAddQuyetDinh: function (formData) {
            return axios.post('/api/sinh-vien/them-quyet-dinh-tot-nghiep', formData);
        },
        ...
        updateQdTrangThai: function (formData) {
            return axios.put("/api/dot-xet-tot-nghiep/updateQd-trang-thai/" + formData.dxtn_id, formData);
        },
    }
